...
class Datatech_itemcodification_user extends MY_Controller
{
    private $class_link = 'eis/datatech_itemcodification_user';
    ...
    {
        if (!checkPermission('MASTERITEM.CODIFICATION.UPDATE')) {
        ...
        $data['msubcodes'] = $this->db->query(
            ...
            where datatex_m_subcode.dtmsubcode_id in (1,2,12,22,31)
        ...
        $data['techInfs'] = $this->db->query(
            ...
            where dtmsubcodetechinf_id not in (35, 36, 37, 38, 39, 40, 7, 12, 11, 14, 19) and
            dtmsubcodetechinf_is_active = 't'
    ...
    public function autocomplete_subcode_hierarchy()
    {
        ...
        $q .= " ORDER BY datatex_m_subcode_hierarchy.dtmsubcodehierarchy_code ASC";
