...
<form id="<?php echo $form_id; ?>" class="form-horizontal">
    ...
    <button type="submit" name="btnSubmit" id="idbtnSubmit<?php echo $form_id; ?>" onclick="action_submit_techinfhierarchy_batch('<?php echo $form_id; ?>')" class="btn btn-sm btn-info">
...
<script type="text/javascript">
    function action_submit_techinfhierarchy_batch(form_id) {
        ...
        $.ajax({
            url: '<?php echo base_url() . $class_link . '/action_submit_techinfhierarchy_batch' ?>',
            type: "POST",
