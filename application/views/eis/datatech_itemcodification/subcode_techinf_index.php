...
$dataJS['id'] = $id;
$this->load->section('scriptJS', $class_link . '/subcode_techinf_index_js', $dataJS);
?>
<!-- Default box -->
<div class="card">
    <div class="card-header">
        <h3 class="card-title">Tech Information </h3>

        <div class="card-tools">
            <?php if (checkPermission('MASTERITEM.CODIFICATION.INSERTBATCH')) : ?>
                <button class="btn btn-sm btn-default" onclick="subcode_techinfhierarchy_formbatch('<?= $id ?>')"> <i class="fa fa-upload"></i> Batch</button>
            <?php endif; ?>
