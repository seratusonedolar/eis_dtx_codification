...
<div class="card">
	<div class="card-header">
		<h3 class="card-title">Reject Based Main Category</h3>
		<hr>
		<button class="btn btn-sm btn-success" id="idbtnsync" onclick="window.location.reload()"> <i class="fas fa-sync"></i> Submit </button>
		<div class="card-tools">
