<script type="text/javascript">
	function partialtablesearch(jsonRequest) {
		$.ajax({
			type: 'POST',
	...
	function partialformsearchtechinf(dtmsubcode_id, dtmitem_id = '', slug = '') {
		$.ajax({
			type: 'GET',
			url: '<?php echo base_url() . $class_link . '/partialformsearchtechinf'; ?>',
			async: false,
			data: {
				dtmsubcode_id: dtmsubcode_id,
				dtmitem_id: dtmitem_id,
